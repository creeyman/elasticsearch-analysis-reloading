...
public class ReloadableSynonymTokenFilter  extends TokenFilter implements Reloadable {
    ...
    private final ReloadableSynonymTokenFilterFactory.SynonymMapBuilder synonymMapBuilder;
     ...
     */
    public ReloadableSynonymTokenFilter(TokenStream input, SynonymMap synonyms, ReloadableSynonymTokenFilterFactory.SynonymMapBuilder synonymMapBuilder, boolean ignoreCase) {
      super(input);
    ...
    */
    ...
    public void reload() {
        ...
        this.futureInputs = new PendingInput[rollBufferSize];
        this.futureOutputs = new PendingOutputs[rollBufferSize];
        for(int pos=0;pos<rollBufferSize;pos++) {
